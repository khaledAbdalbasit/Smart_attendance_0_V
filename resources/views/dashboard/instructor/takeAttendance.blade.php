...
@section('content')
    ...
    <script>
        ...
        let URL = "https://4464-41-234-34-14.ngrok-free.app";
        // Start camera
        startButton.addEventListener('click', () => {
            ...
            videoFeed.src = URL+"/video_feed?course_id=" + courseId;
        ...
        async function fetchAttendance() {
            ...
            try {
                const response = await fetch(`${URL}/api/get_attendance?course_id=${courseId}&week_id=${weekId}`);
